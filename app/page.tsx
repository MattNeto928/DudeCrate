    ...
    <GoogleOAuthProvider clientId="229259974112-1de9qiggh25q2jkjgubjr7d04mf16qe7.apps.googleusercontent.com">
      <div className="flex flex-col min-h-[100dvh]">
              ...
              <div className="grid max-w-[1300px] mx-auto gap-4 sm:grid-cols-2 md:gap-16 justify-center">
                <div className="flex flex-col items-start space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4">
                    <Link
                      className="inline-flex h-9 items-center justify-center rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 transform hover:-translate-y-1 transition-all duration-300 ease-in-out"
                      href="/customize"
                    >
                      Customize Your Bottle Opener
                    </Link>
                    <Link
                      className="inline-flex h-9 items-center justify-center rounded-md border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 transform hover:-translate-y-1 transition-all duration-300 ease-in-out"
                      href="/bottle-openers"
                    >
                      Shop Bottle Openers
                    </Link>
            ...
            <div className="container space-y-12 px-4 md:px-6 mx-auto max-w-5xl">
              <div className="flex flex-col items-start space-y-4 text-left">
                <div className="grid gap-[25vw] sm:grid-cols-1 sm md:grid-cols-2 lg:grid-cols-4 pb-24 w-full items-center justify-center ">
                  ...
                  >
                    <div className="flex basis-full flex-col p-4 tracking-tight text-slate-900/50 sm:basis-1/2 w-[20rem] h-[20rem]">
            ...
            <div className="container grid items-center justify-center gap-4 px-4 md:px-6 mx-auto max-w-5xl">
              ...
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  ...
                  <Link
                    className="underline underline-offset-2 transition-all duration-300 ease-in-out hover:text-gray-900"
                    href="#"
                  >
                    Terms & Conditions
                  </Link>
        ...
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
          <p className="text-xs text-gray-500">© 2024 Custom Bottle Opener. All rights reserved.</p>
          <nav className="sm:ml-auto flex gap-4 sm:gap-6">
            <Link
              className="text-xs hover:underline underline-offset-4 transition-all duration-300 ease-in-out hover:text-gray-900"
              href="#"
            >
              Terms of Service
            </Link>
